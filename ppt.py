...
def handle_page(main_page):
    if main_page == "VPO":
        ...
        # ... (El resto del código permanece igual, incluyendo VPO Consultorías y VPD)

    elif main_page == "VPD":
        # ... (El código para VPD permanece sin cambios)
        # (Por brevedad, no se muestra aquí, pero se asume que está incluido en el código completo)
