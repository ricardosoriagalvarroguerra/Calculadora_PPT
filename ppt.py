...
# **Nota:** Se recomienda manejar las contraseñas de forma más segura utilizando variables de entorno o servicios de gestión de secretos.
    ...
    if main_page == "VPO":
        ...
        if view == "Misiones":
            ...
            if view == "Misiones":
                ...
                if page == "Requerimiento del área":
                    ...
                    fig1 = crear_dona(
                        ...
                        color_map=vpd_area_color_map,  # Puedes ajustar el color_map si es necesario
                        hole=0.5,        # Aumento del hole para anillo más delgado
                        height=300,      # Reducción de tamaño del gráfico
                        margin_l=50      # Ajuste de márgenes
                    )
                ...
                # Página DPP 2025 para Consultorías VPD
                    ...
                    fig4 = crear_dona(
                        ...
                        nombres='VPD/AREA',
                        valores='Total',
                        titulo="Distribución por VPD/AREA (Actualizado)",
                        color_map=vpd_area_color_map,
                        hole=0.5,        # Aumento del hole para anillo más delgado
                        height=300,      # Reducción de tamaño del gráfico
                        margin_l=50      # Ajuste de márgenes
            ...
            if view == "Misiones":
                ...
                file_path = 'BDD_Ajuste.xlsx'
                sheet_name = 'Misiones_VPF'  # Hoja correspondiente para Misiones VPF
                ...
                cache_file = 'cache/VPF_Consultorías_DPP2025.csv'
                cache_dir = 'cache'
