...
def handle_page(main_page):
    ...
    if main_page == "VPO":
        ...
        elif main_page == "Consultorías":
            # Aquí debes implementar la lógica específica para Consultorías si es necesario
            st.header("Consultorías - Página en Desarrollo")
            st.write("Aquí puedes agregar las funcionalidades específicas para Consultorías.")
            # Puedes replicar el manejo de vistas, subpáginas, autenticación de datos, etc.
